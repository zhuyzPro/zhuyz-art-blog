...
function addRightMenuClickEvent() {
  // Some optional features (comments and music) are intentionally disabled on
  // this personal blog. Keep their absent menu entries inert so the shared
  // right-click menu script can still initialise the remaining actions.
  [
    "menu-backward",
    "menu-forward",
    "menu-refresh",
